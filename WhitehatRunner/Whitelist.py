...
class Whitelist:
    ...
    def whitelist_imports(self, the_imports: str, the_froms: str | None = None, the_as: str | None = None):
        ...
        all_imports = list(set([port for port in the_imports_lst if port not in blocked and port not in self.imports]))
    ...
    def whitelist_attribute(self, attr: str):
        ...
        attrs = attr.split(',')
        attrs = list(set(attr for attr in attrs if attr not in self.attributes and attr not in blocked))
